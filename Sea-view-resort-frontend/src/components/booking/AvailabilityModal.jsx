        ...
        {externalLoading && (
          <div className="absolute inset-0 bg-white bg-opacity-90 flex items-center justify-center z-10 rounded-xl backdrop-blur-sm">
            <div className="text-center px-4">
              <div className="animate-spin rounded-full h-12 w-12 border-4 border-gray-200 border-t-green-600 mx-auto mb-3"></div>
                ...
                <div className="flex items-center justify-center p-2 bg-green-50 border border-green-200 rounded-2xl shadow-sm text-center">
                  <div className="text-center">
                    ...
                    <p className="text-green-700 text-xs">
                      La habitación está disponible para las fechas
                      seleccionadas
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">
                      {formatPrice(availabilityData?.precioPorNoche || 0)}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span>Noches:</span>
                    <span className="font-medium">
                      {availabilityData?.noches || 0}
                    </span>
                  </div>
                  <div className="border-t pt-2 flex justify-between font-semibold text-lg">
                    <span>Total:</span>
                    <span className="text-blue-900">
                      {formatPrice(availabilityData?.precioTotal || 0)}
                    </span>
                  </div>
                </div>
              </div>
                ...
                >
                  <div className="flex items-start gap-3 p-4 rounded-2xl border bg-red-50 border-red-200 shadow-sm">
                    ...
                    <div className="flex-1">
                      <h3 className="text-red-900 font-semibold text-base leading-6">
                ...
                <div className="flex items-center justify-center p-3 bg-red-50 border border-red-200 rounded-2xl shadow-sm text-center">
                  <div className="text-center">
                    ...
                    <p className="text-red-700 text-sm">
                      La habitación no está disponible para las fechas
                      seleccionadas
                    </p>
                  </div>
                </div>
